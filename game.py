...
board = pygame.transform.scale(pygame.image.load(os.path.join("img","ajedrez.png")), (750, 750))
...
def redraw_gameWindow(win, bo, p1, p2, color, ready):
    ...
    try:
        txt = font.render(bo.p1Name + "\'s Tiempo: " + str(formatTime2), 1, (255, 255, 255))
        txt2 = font.render(bo.p2Name + "\'s Tiempo: " + str(formatTime1), 1, (255,255,255))
